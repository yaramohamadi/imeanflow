...
def _build_plain_sit(config, *, eval_mode=False):
    ...
    return PlainSiT(
        ...
        gt_on_rollout_solver=str(
            config.model.get("sit_gt_on_rollout_solver", "euler")
        ),
        ...
        gt_on_traj_omega=float(config.model.get("sit_gt_on_traj_omega", 1.5)),
        gt_on_traj_index_min=int(
            config.model.get("sit_gt_on_traj_index_min", 0)
        ),
        eval=eval_mode,
    )
