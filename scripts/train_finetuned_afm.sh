...
AFM_LOAD_GENERATOR_EMA="${AFM_LOAD_GENERATOR_EMA:-False}"
...
echo "Max post-training batches: $AFM_MAX_POSTTRAIN_BATCHES"
echo "Load generator EMA: $AFM_LOAD_GENERATOR_EMA"
...
COMMON_CONFIG_ARGS=(
  ...
  --config.afm.max_posttrain_batches="$AFM_MAX_POSTTRAIN_BATCHES"
  --config.afm.load_generator_ema="$AFM_LOAD_GENERATOR_EMA"
