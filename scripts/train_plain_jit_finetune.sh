...
LOAD_FROM="${LOAD_FROM:-/home/ens/Zdehghani/imeanflow/files/weights/JiT-H-16-256.pth}"
...
case "${DATASET_NAME}" in
  caltech101|caltech-101)
    ...
    DATASET_ROOT="${DATASET_ROOT:-/home/ens/Zdehghani/datasets/caltech-101_images}"
    FID_CACHE_REF="${FID_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fid_stats/caltech-101-fid_stats.npz}"
    FD_DINO_CACHE_REF="${FD_DINO_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fdd_stats/caltech-101-fd_dino-vitb14_stats.npz}"
    ;;
  artbench10|artbench-10)
    DATASET_LABEL="artbench10"
    DATASET_ROOT="${DATASET_ROOT:-/home/ens/Zdehghani/datasets/artbench-10_images}"
    FID_CACHE_REF="${FID_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fid_stats/artbench-10_processed-fid_stats.npz}"
    FD_DINO_CACHE_REF="${FD_DINO_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fdd_stats/artbench-10-fd_dino-vitb14_stats.npz}"
    ;;
  cub200|cub-200|cub-200-2011)
    DATASET_LABEL="cub200"
    DATASET_ROOT="${DATASET_ROOT:-/home/ens/Zdehghani/datasets/cub-200-2011_images}"
    FID_CACHE_REF="${FID_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fid_stats/cub-200-2011_processed-fid_stats.npz}"
    FD_DINO_CACHE_REF="${FD_DINO_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fdd_stats/cub-200-2011-fd_dino-vitb14_stats.npz}"
    ;;
  food101|food-101)
    DATASET_LABEL="food101"
    DATASET_ROOT="${DATASET_ROOT:-/home/ens/Zdehghani/datasets/food-101_images}"
    FID_CACHE_REF="${FID_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fid_stats/food-101_processed-fid_stats.npz}"
    FD_DINO_CACHE_REF="${FD_DINO_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fdd_stats/food-101-fd_dino-vitb14_stats.npz}"
    ;;
  stanfordcars|stanford-cars|cars)
    DATASET_LABEL="stanfordcars"
    DATASET_ROOT="${DATASET_ROOT:-/home/ens/Zdehghani/datasets/stanford-cars_images}"
    FID_CACHE_REF="${FID_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fid_stats/stanford_cars_processed-fid_stats.npz}"
    FD_DINO_CACHE_REF="${FD_DINO_CACHE_REF:-/home/ens/Zdehghani/imeanflow/files/fdd_stats/stanford-cars-fd_dino-vitb14_stats.npz}"
    ;;
  *)
