...
CAIMF_LOAD_GENERATOR_EMA="${CAIMF_LOAD_GENERATOR_EMA:-False}"
...
echo "Max post-training batches: $CAIMF_MAX_POSTTRAIN_BATCHES"
echo "Load generator EMA: $CAIMF_LOAD_GENERATOR_EMA"
...
COMMON_CONFIG_ARGS=(
  ...
  --config.caimf.max_posttrain_batches="$CAIMF_MAX_POSTTRAIN_BATCHES"
  --config.caimf.load_generator_ema="$CAIMF_LOAD_GENERATOR_EMA"
