...
This script:
  1) runs fine-tuning on Caltech with a SiT-based model, dogfit disabled, and null-class embedding enabled
...
JOBNAME="caltech_SiT_nodogfit_${RUN_LABEL}_${NOW}_${SALT}"
