...
export DATASET_ROOT=/scratch/ymbahram/datasets/caltech-101_images
...
export LOAD_FROM=/scratch/ymbahram/weights/JiT-H-16-256.pth

export USE_WANDB="${USE_WANDB:-True}"
export WANDB_PROJECT="${WANDB_PROJECT:-plain_jit_finetune}"
export RUN_LABEL="${RUN_LABEL:-caltech_h16_local}"
