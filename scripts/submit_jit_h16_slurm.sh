...
WEIGHTS="${WEIGHTS:-/scratch/ymbahram/weights/JiT-H-16-256.pth}"
...
dataset_assets() {
  ...
  case "$dataset" in
    caltech101|caltech-101)
      ...
      DATASET_ROOT_OUT="/scratch/ymbahram/datasets/caltech-101_images"
      FID_CACHE_REF_OUT="/scratch/ymbahram/fid_stats/caltech-101-fid_stats.npz"
      FD_DINO_CACHE_REF_OUT="/scratch/ymbahram/fdd_stats/caltech-101-fd_dino-vitb14_stats.npz"
      ;;
    artbench10|artbench-10)
      DATASET_NAME_OUT="artbench10"
      DATASET_ROOT_OUT="/scratch/ymbahram/datasets/artbench-10_images"
      FID_CACHE_REF_OUT="/scratch/ymbahram/fid_stats/artbench-10_processed-fid_stats.npz"
      FD_DINO_CACHE_REF_OUT="/scratch/ymbahram/fdd_stats/artbench-10-fd_dino-vitb14_stats.npz"
      ;;
    cub200|cub-200|cub-200-2011)
      DATASET_NAME_OUT="cub200"
      DATASET_ROOT_OUT="/scratch/ymbahram/datasets/cub-200-2011_images"
      FID_CACHE_REF_OUT="/scratch/ymbahram/fid_stats/cub-200-2011_processed-fid_stats.npz"
      FD_DINO_CACHE_REF_OUT="/scratch/ymbahram/fdd_stats/cub-200-2011-fd_dino-vitb14_stats.npz"
      ;;
    food101|food-101)
      DATASET_NAME_OUT="food101"
      DATASET_ROOT_OUT="/scratch/ymbahram/datasets/food-101_images"
      FID_CACHE_REF_OUT="/scratch/ymbahram/fid_stats/food-101_processed-fid_stats.npz"
      FD_DINO_CACHE_REF_OUT="/scratch/ymbahram/fdd_stats/food-101-fd_dino-vitb14_stats.npz"
      ;;
    stanfordcars|stanford-cars|cars)
      DATASET_NAME_OUT="stanfordcars"
      DATASET_ROOT_OUT="/scratch/ymbahram/datasets/stanford-cars_images"
      FID_CACHE_REF_OUT="/scratch/ymbahram/fid_stats/stanford_cars_processed-fid_stats.npz"
      FD_DINO_CACHE_REF_OUT="/scratch/ymbahram/fdd_stats/stanford-cars-fd_dino-vitb14_stats.npz"
      ;;
    *)
